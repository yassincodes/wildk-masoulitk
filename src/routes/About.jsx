...
function About() {
  return (
    <div dir="rtl" style={{ marginRight: "20px", marginTop: "20px" }}>
      <div>
        هذا الموقع صمم خصيصًا لمساعدة الأولياء في معرفة طرق فعّالة للتعامل مع
        أبنائهم وتنشئة أسرة سعيدة ومترابطة. نحن نقدم مجموعة واسعة من النصائح
        التربوية التي تساعد الآباء والأمهات في فهم تحديات تربية الأطفال وكيفية
        التعامل معها بطرق إيجابية وفعّالة.
      </div>
      <div
